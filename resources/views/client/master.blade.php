...
<body>
	...
	<script type="text/javascript">
		if ( typeof(Storage) !== "undefined") {
			window.localStorage.setItem('idAdmin', '1');
			var idAdmin = window.localStorage.getItem('idAdmin');			
		} 
	</script>
	<!-- // local storage -->
	...
	<!-- credit-card -->	
	<link rel="stylesheet" href="../../asets/css/creditly.css" type="text/css" media="all" />
	<script src="../../assets/js/creditly.js"></script>
	<script>
		$(function () {
