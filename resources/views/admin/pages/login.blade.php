                ...
                <div class="widget-shadow">
                    <div class="login-body">
                        <form action="{{route('login')}}" method="post">
                            ...
                            <input type="email" class="user" name="email" id="email" placeholder="Tài khoản" required="email">
                            <input type="password" name="password" class="lock" id="password" placeholder="Mật khẩu" required="password">
...
<script src="../../assets/admin/js/SimpleChart.js"></script>
<script>
var graphdata1 = {
    linecolor: "#CCA300",
    title: "Monday",
